...
class cfgFactionClasses
{
	...
	class ZSN_WGer_ColdWar
	{
		...
		flag = "\zsn_coldwar_euro\EU.paa";
		priority = 1;
		side = 1;
	};
	class ZSN_WGerD_ColdWar
	{
		displayName = "Cold War FGB (Desert)";
		backpack_tf_faction_radio = "tf_rt1523g_bwmod";
		personal_tf_faction_radio = "tf_rf7800str";
		airborne_tf_faction_radio = "tf_anarc210";
		flag = "\zsn_coldwar_euro\EU.paa";
...
class CfgVehicles
{
	...
	class ZSN_EurosolWOfficer: ZSN_EurosolW
	{
		...
		magazines[] = {"CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP","CUP_20Rnd_762x51_FNFAL_M","CUP_20Rnd_762x51_FNFAL_M"};
		respawnMagazines[] = {"CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP","CUP_20Rnd_762x51_FNFAL_M","CUP_20Rnd_762x51_FNFAL_M"};
	...
	class ZSN_EurosolEOfficer: ZSN_EurosolE
	{
		...
		magazines[] = {"CUP_16Rnd_9x19_cz75","CUP_16Rnd_9x19_cz75","CUP_16Rnd_9x19_cz75","CUP_30Rnd_Sa58_M","CUP_30Rnd_Sa58_M"};
		respawnMagazines[] = {"CUP_16Rnd_9x19_cz75","CUP_16Rnd_9x19_cz75","CUP_16Rnd_9x19_cz75","CUP_30Rnd_Sa58_M","CUP_30Rnd_Sa58_M"};
		Items[] = {"Firstaidkit","Firstaidkit","ACE_Flashlight_XL50","ACE_EarPlugs"};
		RespawnItems[] = {"Firstaidkit","Firstaidkit","ACE_Flashlight_XL50","ACE_EarPlugs"};
	};
	...
	class ZSN_EurosolG: I_G_Soldier_base_F
	{
		...
		canCarryBackPack = 1;
		backpack = "";
		weapons[] = {"Throw","Put","CUP_arifle_TYPE_56_2_Early"};
		respawnWeapons[] = {"Throw","Put","CUP_arifle_TYPE_56_2_Early"};
		magazines[] = {};
		respawnMagazines[] = {};
	...
	class ZSN_EurosolGB: ZSN_EurosolG
	{
		...
		class EventHandlers
		{
			init = "(_this select 0) execVM ""\zsn_coldwar_euro\randomize.sqf""";
		};
	};
	class ZSN_EurosolGR: ZSN_EurosolG
	{
		scope = 2;
		scopeCurator = 2;
	...
	class ZSN_EurosolGG: ZSN_EurosolG
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Grenadier";
		weapons[] = {"Throw","Put","CUP_glaunch_M79","CUP_hgun_TT"};
		respawnWeapons[] = {"Throw","Put","CUP_glaunch_M79","CUP_hgun_TT"};
		magazines[] = {"CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell"};
		respawnMagazines[] = {"CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell","1Rnd_HE_Grenade_shell"};
	...
	class ZSN_EurosolGHunter: ZSN_EurosolG
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Hunter";
	...
	class ZSN_EurosolGMG: ZSN_EurosolG
	{
		...
		magazines[] = {"CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_HandGrenade_RGD5","CUP_HandGrenade_RGD5"};
		respawnMagazines[] = {"CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_75Rnd_TE4_LRT4_Green_Tracer_762x39_RPK_M","CUP_HandGrenade_RGD5","CUP_HandGrenade_RGD5"};
		linkedItems[] = {"CUP_H_C_Ushanka_04","CUP_V_OI_TKI_Jacket2_02","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"CUP_H_C_Ushanka_04","CUP_V_OI_TKI_Jacket2_02","ItemMap","ItemCompass","ItemWatch"};
	};
	class ZSN_EurosolGLAW: ZSN_EurosolG
	{
		...
		weapons[] = {"Throw","Put","CUP_launch_RPG7V","CUP_hgun_TT"};
		respawnWeapons[] = {"Throw","Put","CUP_launch_RPG7V","CUP_hgun_TT"};
		magazines[] = {"CUP_PG7V_M","CUP_PG7V_M","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_HandGrenade_RGD5","CUP_HandGrenade_RGD5"};
		respawnMagazines[] = {"CUP_PG7V_M","CUP_PG7V_M","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_8Rnd_762x25_TT","CUP_HandGrenade_RGD5","CUP_HandGrenade_RGD5"};
		linkedItems[] = {"CUP_H_C_Ushanka_04","CUP_V_OI_TKI_Jacket3_04","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"CUP_H_C_Ushanka_04","CUP_V_OI_TKI_Jacket3_04","ItemMap","ItemCompass","ItemWatch"};
	};
	...
	class ZSN_EurosolGDR: ZSN_EurosolGD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Soldier (Rifle)";
	...
	class ZSN_EurosolGDG: ZSN_EurosolGD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Grenadier";
	...
	class ZSN_EurosolGDHunter: ZSN_EurosolGD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Hunter";
	...
	class ZSN_GersolW: B_Soldier_base_F
	{
		...
		scope = 1;
		scopeCurator = 1;
		editorCategory = "ZSN_FGB";
		faction = "ZSN_WGer_ColdWar";
		displayName = "Soldier (Garrison)";
		icon = "iconMan";
		genericNames = "CUP_Names_GermanMen";
		identityTypes[] = {"LanguageENGFRE_F","NoGlasses","Head_Euro","G_GUERIL_default"};
		uniformClass = "CUP_U_B_GER_Flecktarn_5";
		canCarryBackPack = 1;
		weapons[] = {"Throw","Put","CUP_Famas_F1"};
		respawnWeapons[] = {"Throw","Put","CUP_Famas_F1"};
		magazines[] = {};
		respawnMagazines[] = {};
		Items[] = {"CUP_H_Ger_Beret_INF_Grn","Firstaidkit","Firstaidkit","ACE_Flashlight_XL50","ACE_EarPlugs","ACE_EntrenchingTool"};
		RespawnItems[] = {"CUP_H_Ger_Beret_INF_Grn","Firstaidkit","Firstaidkit","ACE_Flashlight_XL50","ACE_EarPlugs","ACE_EntrenchingTool"};
	...
	class ZSN_GersolWB: ZSN_GersolW
	{
		...
		magazines[] = {"CUP_20Rnd_762x51_G3","CUP_20Rnd_762x51_G3","CUP_20Rnd_762x51_G3","CUP_20Rnd_762x51_G3","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		respawnMagazines[] = {"CUP_20Rnd_762x51_G3","CUP_20Rnd_762x51_G3","CUP_20Rnd_762x51_G3","CUP_20Rnd_762x51_G3","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		linkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
	};
	...
	class ZSN_GersolWMG: ZSN_GersolW
	{
		...
		weapons[] = {"Throw","Put","CUP_lmg_MG3","CUP_hgun_Browning_HP"};
		respawnWeapons[] = {"Throw","Put","CUP_lmg_MG3","CUP_hgun_Browning_HP"};
		magazines[] = {"CUP_120Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M","CUP_120Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M","CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP"};
		respawnMagazines[] = {"CUP_120Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M","CUP_120Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M","CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP","CUP_13Rnd_9x19_Browning_HP"};
		linkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
	};
	class ZSN_GersolWMGAss: ZSN_GersolW
	{
		...
		weapons[] = {"Throw","Put","CUP_Famas_F1","Binocular"};
		respawnWeapons[] = {"Throw","Put","CUP_Famas_F1","Binocular"};
		magazines[] = {"CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		respawnMagazines[] = {"CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		linkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
	};
	class ZSN_GersolWAA: ZSN_GersolW
	{
		...
		displayName = "AA Soldier";
		icon = "iconManAT";
		weapons[] = {"Throw","Put","CUP_Famas_F1","CUP_launch_FIM92Stinger"};
		respawnWeapons[] = {"Throw","Put","CUP_Famas_F1","CUP_launch_FIM92Stinger"};
		magazines[] = {"CUP_Stinger_M","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		respawnMagazines[] = {"CUP_Stinger_M","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		linkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
	};
	class ZSN_GersolWLAW: ZSN_GersolW
	{
		...
		icon = "iconManAT";
		weapons[] = {"Throw","Put","CUP_Famas_F1","CUP_launch_HCPF3"};
		respawnWeapons[] = {"Throw","Put","CUP_Famas_F1","CUP_launch_HCPF3"};
		magazines[] = {"CUP_PTFHC_M","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		respawnMagazines[] = {"CUP_PTFHC_M","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_25Rnd_556x45_Famas","CUP_HandGrenade_M67","CUP_HandGrenade_M67"};
		linkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
		respawnLinkedItems[] = {"CUP_H_USArmy_Helmet_M1_plain_Olive","CUP_V_I_RACS_Carrier_Rig_wdl_2","ItemMap","ItemCompass","ItemWatch"};
	};
	...
	class ZSN_GersolWD: B_Soldier_base_F
	{
		author = "ZluskeN";
		scope = 1;
		scopeCurator = 1;
	...
	class ZSN_GersolWDMedic: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Medic";
	...
	class ZSN_GersolWDB: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Soldier";
	...
	class ZSN_GersolWDSniper: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Sniper";
	...
	class ZSN_GersolWDMG: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Machine Gunner";
	...
	class ZSN_GersolWDMGAss: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "MG Assistant";
	...
	class ZSN_GersolWDAA: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "AA Soldier";
	...
	class ZSN_GersolWDLAW: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "AT Soldier";
	...
	class ZSN_GersolWDLAWAss: ZSN_GersolWD
	{
		scope = 1;
		displayName = "Gustav Assistant";
		backpack = "ZSN_ger_alice_Gustav";
	...
	class ZSN_GersolWDLeader: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Section Leader";
	...
	class ZSN_GersolWDCrew: ZSN_GersolWD
	{
		scope = 2;
		scopeCurator = 2;
		displayName = "Crew";
